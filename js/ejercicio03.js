...
//Funciones anonimas sin parmetros (version extendida)
lastLogin = new Date ();
    isNewUser = function (){
    const hoy = new Date();
    ...
    console.log("Test1- fecha del ultimo accesso es igual a la fecha de hoy");
...
//funciones anonimas con párametros  (version arrow lambda)
...
console.log (`El resultado de la sumade 15+ 83 es : ${sumar(15,83)}`);

/* cuando la funcion anonima tiene ubna sola linea de opracion se puede usar una version simplificada que no usa {} (llaves, ni la palabra reservada)*/
...
recoverPassword("240755@gmail.com", 
